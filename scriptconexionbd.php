...
<body>
                        ...
                        <div class="col-md-12">
                            <div class="alert alert-info" role="alert">
                                ...
                                <div style="margin-top: 10px; text-align: center;">
                                    <pre
                                        id="scriptText">&lt;script src="https://chatpana.com/flashbot_verify/static/js/chatbot.js" data-api-key="<?php echo $_SESSION['api_key']; ?>"&gt;&lt;/script&gt;</pre>
                                </div>

                                <div style="flex-grow: 1; text-align: justify;">
                                    Hemos enviado un correo electrónico de confirmación a la dirección que proporcionaste. Por favor, abre el mensaje y haz clic en el enlace de verificación para activar tu cuenta. Este paso es necesario para asegurar la autenticidad de tu registro y acceder a todas las funcionalidades de nuestra plataforma.

                                    Si no encuentras el correo en tu bandeja de entrada, revisa la carpeta de spam o correo no deseado.

                                    Gracias por unirte a nuestra comunidad. ¡Estamos aquí para ayudarte en cada paso del proceso!
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#headerContainer').load('header-login.html');
